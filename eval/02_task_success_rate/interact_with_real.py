...
class EvalArguments:
    ...
    enable_thinking: bool = field(default=False, metadata={"help": "Enable thinking mode (Qwen3 Best Practices: temp=0.6, top_p=0.95, top_k=20, min_p=0, max_tokens=32768)"})
...
def _build_evaluator(args):
    ...
    # Select appropriate agent class based on api_key
    api_class = APIAgent
